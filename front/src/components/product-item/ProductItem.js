...
export const ProductItem = ({productItem}) => {
    const { title, condition, sold_quantity, thumbnail , description, price } = productItem;
    return (
        <div className="product">
            <div className="product__detail no-gutters">
                <img className="product__image" loading='lazy' src={thumbnail} alt={title} title={title}/>
